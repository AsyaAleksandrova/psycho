...
function Layout() {
  ...
  return (
    <div className='root'>
      ...
      <motion.div className='root__lineright' animate={{ width: ['0%', '100%', '45%'], top: '500px', left: ['0%', '0%', '55%'] }} initial={{ width: 0, top: '500px', left: 0 }} transition={{ duration: 1, delay: 1.5 }}></motion.div>
      ...
      <motion.div className='root__linedeco' animate={{ width: '55%', top: 0, left: 0 }} initial={{ width: 0, top: 0, left: 0 }} transition={{ duration: 1, delay: 1 }}></motion.div>
